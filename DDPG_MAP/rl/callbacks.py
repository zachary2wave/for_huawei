...
class TrainEpisodeLogger(Callback):
    ...
    def on_episode_end(self, episode, logs):
        ...
        template = '{step: ' + nb_step_digits + 'd}/{nb_steps}: episode: {episode}, episode steps: {episode_steps}, episode reward: {episode_reward:.3f}, {metrics}'
        variables = {
            'step': self.step,
